...
function crearLibro($datosLibro)
{
    ...
    $respuesta["usuario"] = "Libro insertado correctamente en la bd";
    $sentencia = null;
    $conexion = null;
    return $respuesta;
}

function actualizarLibro($datosLibro)
{
    try {
        $conexion = new PDO("mysql:host=" . SERVIDOR_BD . ";dbname=" . NOMBRE_BD, USUARIO_BD, CLAVE_BD, array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES 'utf8'"));
    } catch (PDOException $e) {
    ...
    $respuesta["usuario"] = "Libro actualizado correctamente en la bd";
    $sentencia = null;
    $conexion = null;
    return $respuesta;
}

function borrarLibro($datosLibro)
{
    try {
        $conexion = new PDO("mysql:host=" . SERVIDOR_BD . ";dbname=" . NOMBRE_BD, USUARIO_BD, CLAVE_BD, array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES 'utf8'"));
    } catch (PDOException $e) {
    ...
    $respuesta["usuario"] = "Libro borrado correctamente en la bd";
    $sentencia = null;
    $conexion = null;
    return $respuesta;
}
